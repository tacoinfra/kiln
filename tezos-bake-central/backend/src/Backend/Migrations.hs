...
preMigrate chainId =
  ...
  >=> dropColumnIfExists (QualifiedIdentifier Nothing "ProtocolIndex") "constants#blockReward"
  >=> dropColumnIfExists (QualifiedIdentifier Nothing "ProtocolIndex") "constants#endorsementReward"
