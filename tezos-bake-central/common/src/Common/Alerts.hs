...
bakerInsufficientFundsDescriptions _ = BakerErrorDescriptions
  ...
  , _bakerErrorDescriptions_problem = [
      "Bakers receive baking and endorsing rights based on the number of rolls (1 roll = 8,000ꜩ) in their staking balance (the baker’s balance plus any tez delegated to them). This baker’s staking balance is less than one roll and will not receive any baking or endorsing rights."
      ]
