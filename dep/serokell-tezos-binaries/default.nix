...
stdenv.mkDerivation rec {
  ...
  src = fetchzip {
      url = "https://github.com/serokell/tezos-packaging/releases/download/octez-v${version}/binaries-octez-v${version}.tar.gz";
      sha256 = "sha256-e4YIE2Jfka/pSn9G0hZvm5Inx2Q0wA2PnQ3Qn5E14JU=";
      stripRoot = false;
      };
