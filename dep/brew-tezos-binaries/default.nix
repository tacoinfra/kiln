...
let
  ...
  macos_version = "mojave";
    tezos-admin-client = fetchTarball {
      ...
      sha256 = "0hpqq2wa07pdhhiv2dkn55p6i2wysdcy406drshmk3x2il1zv2c5";
    };
    tezos-baker-010-PtGRANAD = fetchTarball {
      ...
      sha256 = "10a6bss34hqm8cr6z4dhhzqps9vzqi6606pfklybakfkhz3smkmj";
    };
    tezos-baker-011-PtHangz2 = fetchTarball {
      ...
      sha256 = "1d8iiyx24asx2dbir4s25zxny8pya2zdqhgpzysg4khlh0md56zh";
    };
    tezos-client = fetchTarball {
      ...
      sha256 = "0nlsynizc65fx5i1i9ca7amq33wwfizvhh1gppj1aypzwdsd32c5";
    };
    tezos-endorser-010-PtGRANAD = fetchTarball {
      ...
      sha256 = "0zrd4craxlsav2m917kp2zif2vvjcbj82rv7imjrjrlpxziz8ff5";
    };
    tezos-endorser-011-PtHangz2 = fetchTarball {
      ...
      sha256 = "154lbyg0x9sfg4wxq16ndp127r7r1v0cag5xm9h4xfqlasvw093i";
    };
    tezos-node = fetchTarball {
      ...
      sha256 = "1hx6cqfm9ap51ca0z131x5l0ilqhprg6ma9zw1gbf36kmqi3prn1";
    };
