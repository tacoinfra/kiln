...
Check out `docker run --rm obsidiansystems/kiln:0.7.3 --help` for more command-line options. For example, you can run the monitor on babylonnet by passing `--network=babylonnet`.
