...
instance B.TezosBinary (Some OpKindTag) where
  ...
  get = B.get @Word8 >>= \case
    ...
    107 -> pure $ This (OpKindTag_Manager OpKindManagerTag_Reveal)
    108 -> pure $ This (OpKindTag_Manager OpKindManagerTag_Transaction)
    109 -> pure $ This (OpKindTag_Manager OpKindManagerTag_Origination)
    110 -> pure $ This (OpKindTag_Manager OpKindManagerTag_Delegation)
