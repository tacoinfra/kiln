...
data ManagerOperationMetadata a = ManagerOperationMetadata
  ...
  -- , _managerOperationMetadata_Results :: !(Seq InternalOperationResult) --  "internal_operation_results": { "type": "array", "items": { "$ref": "#/definitions/operation.alpha.internal_operation_result" } }
