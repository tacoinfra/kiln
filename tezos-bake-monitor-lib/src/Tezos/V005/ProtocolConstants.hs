...
module Tezos.V005.ProtocolConstants where
...
data ProtoInfo = ProtoInfo
  ...
  , _protoInfo_quorumMin :: !(Maybe Int) -- "quorum_min": { "type": "integer", "minimum": -2147483648, "exclusiveMinimum": true, "maximum": 2147483647, "exclusiveMaximum": true },
  -- This definition is slightly off spec as the spec doesn't allow for a value of -2^31 or 2^31
  , _protoInfo_quorumMax :: !(Maybe Int) -- "quorum_max": { "type": "integer", "minimum": -2147483648, "exclusiveMinimum": true, "maximum": 2147483647, "exclusiveMaximum": true },
  -- This definition is slightly off spec as the spec doesn't allow for a value of -2^31 or 2^31
  , _protoInfo_minProposalQuorum :: !(Maybe Int) -- "min_proposal_quorum": { "type": "integer", "minimum": -2147483648, "exclusiveMinimum": true, "maximum": 2147483647, "exclusiveMaximum": true },
